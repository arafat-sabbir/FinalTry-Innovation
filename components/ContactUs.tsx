...
const ContactUs = () => {
  return (
    <section
      id="contact"
      className="bg-[url('/assets/background/contact_bg.png')] bg-no-repeat bg-cover dark:bg-opacity-50 w-full flex pb-20"
    >
      <Container>
        <SectionHeading
        ...
        />
        <div className="max-w-3xl dark:shadow-[0_0_10px_#070a13] dark:bg-[#030A1C] dark:p-10 p-10 lg:p-0 rounded-md">
