...
const Footer = () => {
  return (
    <footer id="aboutUs" className="bg-white overflow-hidden dark:bg-gray-900">
      <Container>
            ...
            <div className="w-full -mx-6 lg:w-2/5">
              <div className="px-6">
                ...
                <div className="flex mt-6 -mx-2 gap-4">
                  ...
                  <Link
                    target="_blank"
                    href="https://www.instagram.com/finaltryinnovations/"
                  ...
                  <Link
                    target="_blank"
                    href="https://www.linkedin.com/company/finaltry-innovations"
                    aria-label="LinkedIn"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
